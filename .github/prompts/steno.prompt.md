---
mode: ask
description: Activate Steno Mode for shorthand-first token reduction w/ readable technical precision. Use for compressed resps, steno mode, shorthand mode, or token-saving replies.
